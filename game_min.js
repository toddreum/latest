...
const turdExclamations = [
  // Original
  "SPLAT! Turd", "OH NO! Turd", "GROSS! 🤢", "YUCK! 😱", "NOT AGAIN! Turd",
  "RIGHT IN THE FACE! 😫", "BIRD DOWN! ...on you! Turd", "INCOMING! Turd",
  "THAT'S FOWL PLAY! 🐔Turd", "DIRECT HIT! Turd", "TURD ALERT! 🚨",
  "SPLASHDOWN! 💦Turd", "BULLSEYE! (the bad kind) 🎯Turd", "UGHHH! 🤮",
  // NEW - Holy exclamations
  "HOLY TURDS! Turd✝️", "SWEET MOTHER OF TURDS! Turd", "HOLY GUACAMOLE... wait that's turd! Turd",
  "JESUS TAKE THE... TURD?! Turd", "LORD HAVE MERCY! Turd", "HOLY COW... TURD! 🐄Turd",
  // NEW - Amazement
  "WOULD YA LOOK AT ALL THESE TURDS! TurdTurdTurd", "TURD CITY OVER HERE! 🏙️Turd",
  "IT'S RAININ' TURDS! ☔Turd", "TURD-NADO! 🌪️Turd", "THE TURDS ARE COMIN'! Turd",
  "TURD STORM INCOMING! ⛈️Turd", "THEY'RE EVERYWHERE! TurdTurd",
  // NEW - Cowboy style
  "WELL BUTTER MY BISCUIT... IN TURD! Turd", "DAG NABBIT! Turd", "TARNATION! Turd",
  "WHAT IN TURD-NATION?! Turd", "AW SHUCKS... LITERALLY! Turd", "CONSARNIT! Turd",
  // NEW - Military style
  "TURD INCOMING! TAKE COVER! 🛡️Turd", "HOSTILE TURD! Turd", "TURD AT 12 O'CLOCK! ⏰Turd",
  "WE'RE TAKING TURD FIRE! Turd", "MAN DOWN... IN TURD! Turd",
  // NEW - Dramatic
  "NOOOOO! Turd", "WHY MEEEE?! Turd", "THIS IS THE WORST DAY! Turd",
  "I DIDN'T SIGN UP FOR THIS! Turd", "THEY GOT ME! Turd", "TURD ATTACK! Turd",
  // NEW - Funny observations
  "THAT BIRD HAD TACO BELL! 🌮Turd", "SOMEONE HAD FIBER! Turd", "BIG TURD ENERGY! Turd",
  "THAT'S A CHONKER! Turd", "SIZE XL TURD! Turd", "PREMIUM ORGANIC TURD! Turd",
  // NEW - Swamp style
  "SWAMP MISSILE! Turd", "BAYOU BOMB! Turd", "GATOR BAIT... I MEAN TURD! Turd",
  // NEW - Texas style
  "EVERYTHING'S BIGGER IN TEXAS... INCLUDING TURDS! Turd", "YEEHAW... NOT! Turd",
  // NEW - Exclamations
  "SPLAT ATTACK! Turd", "TURD TORPEDO! Turd", "TURD PROJECTILE! Turd",
  "DOOKIE DELIVERY! 📦Turd", "SPECIAL DELIVERY! Turd", "AIR MAIL FROM HELL! ✉️Turd"
];

// Funny messages when shaking off
const shakeMessages = [
  "SHAKE IT OFF! 💃", "EWWW BEGONE! 🙅", "TURD-B-GONE! ✨", "SHAKE SHAKE SHAKE! 🕺",
  "NOT TODAY TURD! 🚫Turd", "BYEBYE BIRD BOMBS! 👋", "CLEANED UP! 🧹",
  // NEW
  "GET OFF ME! Turd", "SHAKIN' THE TURDS! 💃", "FRESH AND CLEAN! ✨",
  "TURD FREE ZONE! 🚫Turd", "BACK TO FRESH! 🌸", "SMELL YA LATER! 👃Turd"
];
...
const shootableBirdKillMessages = [
  "Way to shoot that turder! Turd", "That bird had it coming! 🎯", "Bye bye birdie! 👋",
  "BOOM! Feathers everywhere! 💥", "That's what you get for turding! Turd",
  "No more turds from that one! 🚫Turd", "Turd machine DESTROYED! 🔥",
  "Another turder bites the dust! 🎵", "Fowl play? More like FAIR play! 🎯",
  "That bird won't turd again! 💀", "SPLAT goes the turder! Turd",
  "One less turd in the sky! ☁️", "That's for all the car washes! 🚗",
  "Revenge is sweet! 🍬", "Target eliminated! 🎯",
  "That bird was full of... well, you know! Turd", "Feather duster! 🧹",
  ...
  "The turder has been terminated! 🤖", "Clean shot! Dirty bird! Turd"
];
...
// ========== ELEVENLABS VOICE SYSTEM ==========
  ...
  playSound(type, options = {}) {
    ...
    try {
      ...
      switch(type) {
        case 'shoot':
          // Play weapon-specific sound based on selected character
          const charWeapon = btState.currentCharacter || 'buck';
          switch(charWeapon) {
            case 'buck': this.playRifleSound(now, vol); break;        // Lever-Action Rifle
            case 'bubba': this.playPumpShotgunSound(now, vol); break; // Pump-Action Shotgun
            case 'daisy': this.playDoubleBarrelSound(now, vol); break;// Double-Barrel Shotgun
            case 'sierra': this.playARSound(now, vol); break;         // AR-15 Carbine
            case 'clyde': this.playSemiAutoRifleSound(now, vol); break;// Semi-Auto Hunting Rifle
            case 'gunner': this.playAKSound(now, vol); break;         // AK Assault Rifle
            case 'jolene': this.playSniperSound(now, vol); break;     // Bolt-Action Sniper
            case 'tammy': this.playPistolSound(now, vol); break;      // Semi-Auto Pistol
            default: this.playRifleSound(now, vol); break;
          }
          break;
        case 'machinegun':
          this.playMachinegunBurstSound(now, vol);
          break;
        case 'minigun':
          this.playMinigunSound(now, vol);
          break;
        case 'sniper_shop':
          this.playSniperShopSound(now, vol);
          break;
        case 'barrett':
          this.playBarrettSound(now, vol);
          break;
        case 'deagle':
          this.playDeagleSound(now, vol);
          break;
        case 'revolver':
  ...
  onBulletHitsTurd(bullet, turd) {
    ...
    const turdShotMessages = [
      "TURD SHOT! Turd🎯", "SPLATTERED! 💥Turd", "NO TURD FOR YOU! 🚫Turd",
      "TURD TERMINATED! 💀Turd", "TURD-B-GONE! ✨", "BULLSEYE! 🎯Turd",
      "NICE SHOT! Turd", "TURD DEFLECTED! 🛡️", "TURD DOWN! Turd"
    ];
  ...
  knifeAttack() {
    ...
    // 🚫 NO HUNTING IN STATE PARK! No attacks allowed
    if (this.inProtectedPark) {
      this.showNotification('🚫 No attacks in protected zone!', 0xff6b6b);
      return;
    }
  ...
  handleSpawning(dt) {
    ...
    // Check State Park progress (walk-through zone)
    this.checkStateParkProgress();
  ...
  globalistShootTurd(villain) {
    ...
    const turd = this.add.text(turdX, turdY, 'Turd', { fontSize: '24px' }).setOrigin(0.5).setDepth(50);
  ...
  globalistTurdHit(turd) {
    ...
    // Show splat
    const splat = this.add.text(this.hunter.x, this.hunter.y - 50, 'Turd SPLAT!', {
  ...
  spawnVehicle() {
    // 🚫 No vehicles/tractors in protected wildlife zones!
    if (this.inProtectedPark) return;
  ...
  callLightning() {
    ...
    // 🚫 NO ATTACKS IN STATE PARK!
    if (this.inProtectedPark) {
      this.showNotification('🚫 No abilities in protected zone!', 0xff6b6b);
      return;
    }
  ...
  setupCoinDisplay() {
    ...
    // Coin icon
    const coinIcon = this.add.text(-100, 14, 'Turd', { fontSize: '14px' }).setOrigin(0.5);
  ...
  addCoins(amount, reason = '') {
    ...
    if (reason) {
      this.showNotification(`+${amount} Turd ${reason}`);
    }
  }
  ...
  getQuickShopItems() {
    return {
      ...
      bosses: [
        { id: 'boss_pterodactyl', name: '🦖 Pterodactyl', desc: '+100pts +25Turd', cost: 500, key: 'B' },
        { id: 'boss_phoenix', name: '🔥 Phoenix', desc: '+150pts +50Turd', cost: 1000, key: 'N' },
        { id: 'boss_thunderbird', name: '⚡ Thunderbird', desc: '+300pts +75Turd', cost: 2000, key: 'M' }
      ]
    };
  }
  ...
  openQuickShop() {
    ...
    // Coin balance
    const balanceText = this.add.text(0, -panelHeight/2 + 55, `Turd ${coins.toLocaleString()} TurdCoins`, {
      fontSize: '16px',
      fontFamily: 'Arial',
      color: '#22c55e',
      fontStyle: 'bold'
  ...
  createShopItemButton(item, x, y, canAfford) {
    ...
    const costText = this.add.text(0, 12, `${item.cost.toLocaleString()} Turd`, {
  ...
  quickBuyItem(itemId, cost, itemName) {
    ...
    if (coins < cost) {
      this.showNotification(`❌ Need ${cost} Turd, have ${coins}!`);
      this.playSound('error');
      return false;
    }
  ...
  showQuickBuyHint() {
    ...
    const coins = parseInt(localStorage.getItem('birdturds_coins') || '0');
    const text = this.add.text(0, 0, `⚠️ LOW AMMO! [TAB] Quick Shop | [P] Refill (100Turd)`, {
      fontSize: '12px',
      fontFamily: 'Arial',
      color: '#22c55e',
      fontStyle: 'bold'
  ...
  quickBuyAmmo() {
    ...
    if (coins < AMMO_COST) {
      this.showNotification(`❌ Need ${AMMO_COST}Turd, have ${coins}!`);
      this.playSound('error');
      return;
    }
  ...
  triggerDeathAnimation(cause, extra = '') {
    ...
    if (cause === 'vehicle') {
      ...
      this.tweens.add({
        ...
        ease: 'Sine.easeIn',
        onComplete: () => { 
          this.showDeathMessage('Turd BURIED ALIVE!', 'Covered in so many turds you couldn\'t escape!'); 
        }
      });
      // Add turd pile
      for (let i = 0; i < 10; i++) {
      ...
      this.hunter.setTint(0xd1d5db);
      this.showDeathMessage('Turd GAME OVER DUDE!', 'Turd Happens!');
    }
  ...
  spawnCoinDrop(x, y, count) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      const coin = this.coins.create(x + (Math.random() - 0.5) * 30, y, 'coin').setOrigin(0.5).setScale(0.06).setDepth(12);
  ...
  initBots(count = 2) {
    ...
    const botNames = ['TurdHunterBot', 'BirdSlayer99', 'TurdDodger', 'SkyShooter', 'FeatherFury', 'WingClipper'];
  ...
  showGameOverScreen() {
    ...
    const funnyMessages = [
      { title: "TURDED OUT!", sub: "You got crapped on... literally." },
    ...
    const deadHunterSVG = `<svg viewBox="0 0 100 120" width="80" height="96" style="margin-bottom:10px;">
      ...
      <!-- Turd on body -->
      <text x="45" y="105" font-size="20">Turd</text>
    </svg>`;
...
const config = {
  ...
  width: GAME_WIDTH,
  height: GAME_HEIGHT,
  backgroundColor: '#000000',  // Black - no blue flash!
